...
int main() {
    ...
    vehiclesArray[6] = new Jet("JBRAND1", "JMODEL1", "diesel", 5);
    vehiclesArray[7] = new Jet("JBRAND2", "JMODEL1", "diesel", 1);
    vehiclesArray[8] = new Skateboard("SKBRAND1", "SKMODEL1");
    vehiclesArray[9] = new Skateboard("SKBRAND2", "SKMODEL2");
    vehiclesArray[10] = new Skates("SBRAND1", "SMODEL1", 3);
    vehiclesArray[11] = new Skates("SBRAND2", "SMODEL2", 10);
